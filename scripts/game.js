...
function game0() {
  balls.push(
    new Ball(ctx.canvas.width / 2, ctx.canvas.height / 2, 10, 3, 0, 1, 1)
  );
...
function game1() {
  balls.push(
    new Ball(ctx.canvas.width / 2 - 40, ctx.canvas.height / 2, 10, 3, 0, 1, 1)
  );
  addControlPaddles(paddles);
  paddles.push(
    new Paddle(
      ctx.canvas.width / 2 - 7.5,
